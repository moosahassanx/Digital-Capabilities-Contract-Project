...
const UploadCSV = () => {
  ...
  const [userInputQ5, setUserInputQ5] = useState([]);
  const [userInputQ6, setUserInputQ6] = useState([]);
  const [userInputQ7, setUserInputQ7] = useState([]);
  const [userInputQ8, setUserInputQ8] = useState([]);
  const [userInputQ9, setUserInputQ9] = useState([]);
  const [userInputQ10, setUserInputQ10] = useState([]);
  ...
  function generateValues()
  {
    ...
    setUserInputQ10(inputStringsQ10);
  }
